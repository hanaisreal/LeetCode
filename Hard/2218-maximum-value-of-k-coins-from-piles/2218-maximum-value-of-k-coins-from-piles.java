class Solution {
    public int maxValueOfCoins(List<List<Integer>> piles, int k) {
        ...
        //dynamic programming
        //create a 2D array dp[i][j] and store the max value of coins for choosing j coins from the first i piles
        
        int[][] dp = new int[piles.size() + 1][k + 1];
        
        //fill the first row  and column of the array with zeros
        Arrays.fill(dp[0], 0 );  //row
